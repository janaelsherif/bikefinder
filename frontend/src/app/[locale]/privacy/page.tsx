...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${t("privacyTitle")} · EuropeBikeFinder`,
  };
}
  ...
  return (
    <PageShell>
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        <h1 className="text-2xl font-semibold text-zinc-900">{t("privacyTitle")}</h1>
        <p className="mt-4 text-sm leading-relaxed text-zinc-700">{t("privacyLead")}</p>
